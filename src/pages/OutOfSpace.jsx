...
import { outOfSpaceData } from "../constants/projects"; // Import the data from data.js
  ...
  return (
    <div className="flex">
      ...
      <div className="fixed left-20 p-4 h-screen bg-transparent">
        <nav>
          <ul className="list-none pl-0">
            ...
            {outOfSpaceData.sections.map((section) => (
      ...
      <div className="w-3/4 p-4" style={{ marginLeft: "25%" }}>
        ...
        {outOfSpaceData.sections.map((section, index) => (
          <div
            key={section.title}
